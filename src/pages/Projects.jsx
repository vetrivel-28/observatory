  ...
  return (
    <div className="page-content fade-in page-container" style={{ padding: '40px 20px', maxWidth: '1000px', margin: '0 auto', fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '60px' }}>
        ...
        <p className="page-subtitle" style={{ color: 'var(--text-muted)' }}>3 production-grade systems built from concept to deployment.</p>
      </div>
      ...
      <div className="projects-container" style={{ maxWidth: '820px', margin: '0 auto', padding: '0 24px', width: '100%', display: 'flex', flexDirection: 'column', gap: '32px' }}>
        {projects.map((p, i) => (
          <div 
            key={i} 
            className="clickable terminal-card"
          ...
          >
            {/* Terminal title bar */}
            <div className="project-title-bar" style={{
              background: '#111d2e',
              ...
              <span className="project-filename" style={{
                fontFamily: 'Space Mono', fontSize: '10px',
                color: '#4a5568', marginLeft: '8px',
              }}>
                {p.filename}
              </span>
              <span className="project-domain-badge tag-pill" style={{
                marginLeft: 'auto',
            ...
            <div className="project-card-body section-content" style={{ padding: '32px' }}>
            ...
            <div className="metric-text" style={{ color: 'var(--accent-cyan)', fontWeight: 'bold', fontSize: '1rem', marginBottom: '16px' }}>
              {p.metric}
            </div>

            <p className="project-desc body-text" style={{ color: 'var(--text-primary)', lineHeight: '1.6', marginBottom: '24px' }}>
              {p.desc}
            </p>
